...
A tiny Minecraft-style voxel sandbox that runs entirely in your web browser, built with [three.js](https://threejs.org/). The whole game — procedural terrain, block building/breaking, survival systems, creatures, and a handful of wild extras — was generated by **Qwen3.8 27b**.
